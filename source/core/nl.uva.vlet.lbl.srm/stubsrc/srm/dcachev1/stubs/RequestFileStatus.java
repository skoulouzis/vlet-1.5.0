...
public class RequestFileStatus extends srm.dcachev1.stubs.FileMetaData implements java.io.Serializable
{
    ...
    public RequestFileStatus(java.lang.String SURL, long size, java.lang.String owner, java.lang.String group,
            int permMode, java.lang.String checksumType, java.lang.String checksumValue, boolean isPinned,
            boolean isPermanent, boolean isCached, java.lang.String state, int fileId, java.lang.String TURL,
            int estSecondsToStart, java.lang.String sourceFilename, java.lang.String destFilename, int queueOrder)
    {
        super(SURL, size, owner, group, permMode, checksumType, checksumValue, isPinned, isPermanent, isCached);
        this.state = state;
        this.fileId = fileId;
        this.TURL = TURL;
    ...
    public synchronized boolean equals(java.lang.Object obj)
    {
        ...
        _equals = super.equals(obj)
                ...
                && ((this.TURL == null && other.getTURL() == null) || (this.TURL != null && this.TURL.equals(other
                        .getTURL())))
                && this.estSecondsToStart == other.getEstSecondsToStart()
                && ((this.sourceFilename == null && other.getSourceFilename() == null) || (this.sourceFilename != null && this.sourceFilename
                        .equals(other.getSourceFilename())))
                && ((this.destFilename == null && other.getDestFilename() == null) || (this.destFilename != null && this.destFilename
                        .equals(other.getDestFilename()))) && this.queueOrder == other.getQueueOrder();
        __equalsCalc = null;
        return _equals;
    }
