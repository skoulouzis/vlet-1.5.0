...
public class SrmPutDoneResponse implements java.io.Serializable
{
    ...
    public SrmPutDoneResponse()
    {
    }

    public SrmPutDoneResponse(gov.lbl.srm.v22.stubs.TReturnStatus returnStatus,
    ...
    /**
     * Gets the returnStatus value for this SrmPutDoneResponse.
     * 
     * @return returnStatus
     */
    ...
    /**
     * Sets the returnStatus value for this SrmPutDoneResponse.
     * 
     * @param returnStatus
     */
    ...
    /**
     * Gets the arrayOfFileStatuses value for this SrmPutDoneResponse.
     * 
    ...
    /**
     * Sets the arrayOfFileStatuses value for this SrmPutDoneResponse.
     * 
    ...
    {
        if (!(obj instanceof SrmPutDoneResponse))
            return false;
        SrmPutDoneResponse other = (SrmPutDoneResponse) obj;
        if (obj == null)
            return false;
        if (this == obj)
            return true;
