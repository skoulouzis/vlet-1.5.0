...
public class SrmGetPermissionResponse implements java.io.Serializable
{
    ...
    private gov.lbl.srm.v22.stubs.ArrayOfTPermissionReturn arrayOfPermissionReturns;

    public SrmGetPermissionResponse()
    {
    }

    public SrmGetPermissionResponse(gov.lbl.srm.v22.stubs.TReturnStatus returnStatus,
            gov.lbl.srm.v22.stubs.ArrayOfTPermissionReturn arrayOfPermissionReturns)
    {
    ...
    /**
     * Gets the arrayOfPermissionReturns value for this
     * SrmGetPermissionResponse.
     * 
     * @return arrayOfPermissionReturns
     */
    public gov.lbl.srm.v22.stubs.ArrayOfTPermissionReturn getArrayOfPermissionReturns()
    {
        return arrayOfPermissionReturns;
    }

    /**
     * Sets the arrayOfPermissionReturns value for this
     * SrmGetPermissionResponse.
     * 
     * @param arrayOfPermissionReturns
     */
    public void setArrayOfPermissionReturns(gov.lbl.srm.v22.stubs.ArrayOfTPermissionReturn arrayOfPermissionReturns)
    {
        this.arrayOfPermissionReturns = arrayOfPermissionReturns;
    }
    ...
    {
        if (!(obj instanceof SrmGetPermissionResponse))
            return false;
        ...
        _equals = true
                ...
                && ((this.arrayOfPermissionReturns == null && other.getArrayOfPermissionReturns() == null) || (this.arrayOfPermissionReturns != null && this.arrayOfPermissionReturns
                        .equals(other.getArrayOfPermissionReturns())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
            SrmGetPermissionResponse.class, true);
