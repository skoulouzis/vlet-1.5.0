...
{
    private gov.lbl.srm.v22.stubs.TSURLReturnStatus[] statusArray;

    public ArrayOfTSURLReturnStatus()
    {
    }

    public ArrayOfTSURLReturnStatus(gov.lbl.srm.v22.stubs.TSURLReturnStatus[] statusArray)
    {
        this.statusArray = statusArray;
    }

    /**
     * Gets the statusArray value for this ArrayOfTSURLReturnStatus.
     * 
     * @return statusArray
     */
    public gov.lbl.srm.v22.stubs.TSURLReturnStatus[] getStatusArray()
    {
        return statusArray;
    }

    /**
     * Sets the statusArray value for this ArrayOfTSURLReturnStatus.
     * 
     * @param statusArray
     */
    public void setStatusArray(gov.lbl.srm.v22.stubs.TSURLReturnStatus[] statusArray)
    {
        this.statusArray = statusArray;
    }

    public gov.lbl.srm.v22.stubs.TSURLReturnStatus getStatusArray(int i)
    {
        return this.statusArray[i];
    }

    public void setStatusArray(int i, gov.lbl.srm.v22.stubs.TSURLReturnStatus _value)
    {
    ...
    {
        if (!(obj instanceof ArrayOfTSURLReturnStatus))
            return false;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
            ArrayOfTSURLReturnStatus.class, true);
