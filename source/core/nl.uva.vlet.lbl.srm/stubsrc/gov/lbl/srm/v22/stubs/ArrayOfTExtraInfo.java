...
{
    private gov.lbl.srm.v22.stubs.TExtraInfo[] extraInfoArray;

    public ArrayOfTExtraInfo()
    {
    }

    public ArrayOfTExtraInfo(gov.lbl.srm.v22.stubs.TExtraInfo[] extraInfoArray)
    {
     ...
     */
    public gov.lbl.srm.v22.stubs.TExtraInfo[] getExtraInfoArray()
    {
        return extraInfoArray;
    }
     ...
     */
    public void setExtraInfoArray(gov.lbl.srm.v22.stubs.TExtraInfo[] extraInfoArray)
    {
        this.extraInfoArray = extraInfoArray;
    }

    public gov.lbl.srm.v22.stubs.TExtraInfo getExtraInfoArray(int i)
    {
        return this.extraInfoArray[i];
    }

    public void setExtraInfoArray(int i, gov.lbl.srm.v22.stubs.TExtraInfo _value)
    {
    ...
    public synchronized boolean equals(java.lang.Object obj)
    {
        ...
        __equalsCalc = obj;
        boolean _equals;
        _equals = true && ((this.extraInfoArray == null && other.getExtraInfoArray() == null) || (this.extraInfoArray != null && java.util.Arrays
                .equals(this.extraInfoArray, other.getExtraInfoArray())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode()
    {
        ...
        {
            for (int i = 0; i < java.lang.reflect.Array.getLength(getExtraInfoArray()); i++)
            {
