...
public class ArrayOfAnyURI implements java.io.Serializable
{
    ...
    public ArrayOfAnyURI(org.apache.axis.types.URI[] urlArray)
    {
    ...
    public synchronized boolean equals(java.lang.Object obj)
    {
        ...
        __equalsCalc = obj;
        boolean _equals;
        _equals = true && ((this.urlArray == null && other.getUrlArray() == null) || (this.urlArray != null && java.util.Arrays
                .equals(this.urlArray, other.getUrlArray())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode()
    {
        ...
        if (getUrlArray() != null)
        {
            for (int i = 0; i < java.lang.reflect.Array.getLength(getUrlArray()); i++)
            {
