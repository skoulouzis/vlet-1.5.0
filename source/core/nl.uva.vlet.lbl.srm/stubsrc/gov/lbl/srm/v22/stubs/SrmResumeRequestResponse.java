...
public class SrmResumeRequestResponse implements java.io.Serializable
{
    private gov.lbl.srm.v22.stubs.TReturnStatus returnStatus;

    public SrmResumeRequestResponse()
    {
    }

    public SrmResumeRequestResponse(gov.lbl.srm.v22.stubs.TReturnStatus returnStatus)
    {
        this.returnStatus = returnStatus;
    }

    /**
     * Gets the returnStatus value for this SrmResumeRequestResponse.
     * 
     * @return returnStatus
     */
    ...
    /**
     * Sets the returnStatus value for this SrmResumeRequestResponse.
     * 
     * @param returnStatus
     */
    ...
    {
        if (!(obj instanceof SrmResumeRequestResponse))
            return false;
        SrmResumeRequestResponse other = (SrmResumeRequestResponse) obj;
        if (obj == null)
            return false;
        if (this == obj)
            return true;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
            SrmResumeRequestResponse.class, true);
