...
public class SrmResumeRequestRequest implements java.io.Serializable
{
    private java.lang.String requestToken;

    private java.lang.String authorizationID;

    public SrmResumeRequestRequest()
    {
    }

    public SrmResumeRequestRequest(java.lang.String requestToken, java.lang.String authorizationID)
    {
    ...
    /**
     * Gets the requestToken value for this SrmResumeRequestRequest.
     * 
     * @return requestToken
     */
    ...
    /**
     * Sets the requestToken value for this SrmResumeRequestRequest.
     * 
     * @param requestToken
     */
    ...
    /**
     * Gets the authorizationID value for this SrmResumeRequestRequest.
     * 
    ...
    /**
     * Sets the authorizationID value for this SrmResumeRequestRequest.
     * 
    ...
    {
        if (!(obj instanceof SrmResumeRequestRequest))
            return false;
        SrmResumeRequestRequest other = (SrmResumeRequestRequest) obj;
        if (obj == null)
            return false;
        if (this == obj)
            return true;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
            SrmResumeRequestRequest.class, true);
