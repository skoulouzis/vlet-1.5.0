...
{
    private gov.lbl.srm.v22.stubs.TSURLLifetimeReturnStatus[] statusArray;

    public ArrayOfTSURLLifetimeReturnStatus()
    {
    }

    public ArrayOfTSURLLifetimeReturnStatus(gov.lbl.srm.v22.stubs.TSURLLifetimeReturnStatus[] statusArray)
    {
     ...
     * @return statusArray
     */
    public gov.lbl.srm.v22.stubs.TSURLLifetimeReturnStatus[] getStatusArray()
    {
        return statusArray;
    }
     ...
     * @param statusArray
     */
    public void setStatusArray(gov.lbl.srm.v22.stubs.TSURLLifetimeReturnStatus[] statusArray)
    {
        this.statusArray = statusArray;
    }

    public gov.lbl.srm.v22.stubs.TSURLLifetimeReturnStatus getStatusArray(int i)
    {
        return this.statusArray[i];
    }

    public void setStatusArray(int i, gov.lbl.srm.v22.stubs.TSURLLifetimeReturnStatus _value)
    {
    ...
    {
        if (!(obj instanceof ArrayOfTSURLLifetimeReturnStatus))
            return false;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
            ArrayOfTSURLLifetimeReturnStatus.class, true);
