...
public class SrmReleaseSpaceResponse implements java.io.Serializable
{
    ...
    public SrmReleaseSpaceResponse(gov.lbl.srm.v22.stubs.TReturnStatus returnStatus)
    {
        this.returnStatus = returnStatus;
    }

    /**
     * Gets the returnStatus value for this SrmReleaseSpaceResponse.
     * 
     * @return returnStatus
     */
    ...
    /**
     * Sets the returnStatus value for this SrmReleaseSpaceResponse.
     * 
     * @param returnStatus
     */
    ...
    {
        if (!(obj instanceof SrmReleaseSpaceResponse))
            return false;
        SrmReleaseSpaceResponse other = (SrmReleaseSpaceResponse) obj;
        if (obj == null)
            return false;
        if (this == obj)
            return true;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
            SrmReleaseSpaceResponse.class, true);
