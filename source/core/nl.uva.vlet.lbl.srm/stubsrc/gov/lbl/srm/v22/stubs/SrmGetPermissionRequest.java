...
public class SrmGetPermissionRequest implements java.io.Serializable
{
    ...
    public SrmGetPermissionRequest()
    {
    }

    public SrmGetPermissionRequest(java.lang.String authorizationID, gov.lbl.srm.v22.stubs.ArrayOfAnyURI arrayOfSURLs,
    ...
    /**
     * Gets the authorizationID value for this SrmGetPermissionRequest.
     * 
    ...
    /**
     * Sets the authorizationID value for this SrmGetPermissionRequest.
     * 
    ...
    /**
     * Gets the arrayOfSURLs value for this SrmGetPermissionRequest.
     * 
     * @return arrayOfSURLs
     */
    ...
    /**
     * Sets the arrayOfSURLs value for this SrmGetPermissionRequest.
     * 
     * @param arrayOfSURLs
     */
    ...
    /**
     * Gets the storageSystemInfo value for this SrmGetPermissionRequest.
     * 
    ...
    /**
     * Sets the storageSystemInfo value for this SrmGetPermissionRequest.
     * 
    ...
    {
        if (!(obj instanceof SrmGetPermissionRequest))
            return false;
        SrmGetPermissionRequest other = (SrmGetPermissionRequest) obj;
        if (obj == null)
            return false;
        if (this == obj)
            return true;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
            SrmGetPermissionRequest.class, true);
