...
{
    private gov.lbl.srm.v22.stubs.TRequestTokenReturn[] tokenArray;

    public ArrayOfTRequestTokenReturn()
    {
    }

    public ArrayOfTRequestTokenReturn(gov.lbl.srm.v22.stubs.TRequestTokenReturn[] tokenArray)
    {
     ...
     * @return tokenArray
     */
    public gov.lbl.srm.v22.stubs.TRequestTokenReturn[] getTokenArray()
    {
        return tokenArray;
    }
     ...
     * @param tokenArray
     */
    public void setTokenArray(gov.lbl.srm.v22.stubs.TRequestTokenReturn[] tokenArray)
    {
        this.tokenArray = tokenArray;
    }

    public gov.lbl.srm.v22.stubs.TRequestTokenReturn getTokenArray(int i)
    {
        return this.tokenArray[i];
    }

    public void setTokenArray(int i, gov.lbl.srm.v22.stubs.TRequestTokenReturn _value)
    {
    ...
    public synchronized boolean equals(java.lang.Object obj)
    {
        ...
        __equalsCalc = obj;
        boolean _equals;
        _equals = true && ((this.tokenArray == null && other.getTokenArray() == null) || (this.tokenArray != null && java.util.Arrays
                .equals(this.tokenArray, other.getTokenArray())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode()
    {
        ...
        {
            for (int i = 0; i < java.lang.reflect.Array.getLength(getTokenArray()); i++)
            {
    ...
    private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
            ArrayOfTRequestTokenReturn.class, true);
