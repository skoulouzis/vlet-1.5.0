...
{
    private gov.lbl.srm.v22.stubs.TGetRequestFileStatus[] statusArray;

    public ArrayOfTGetRequestFileStatus()
    {
    }

    public ArrayOfTGetRequestFileStatus(gov.lbl.srm.v22.stubs.TGetRequestFileStatus[] statusArray)
    {
        this.statusArray = statusArray;
    }

    /**
     * Gets the statusArray value for this ArrayOfTGetRequestFileStatus.
     * 
     * @return statusArray
     */
    public gov.lbl.srm.v22.stubs.TGetRequestFileStatus[] getStatusArray()
    {
        return statusArray;
    }

    /**
     * Sets the statusArray value for this ArrayOfTGetRequestFileStatus.
     * 
     * @param statusArray
     */
    public void setStatusArray(gov.lbl.srm.v22.stubs.TGetRequestFileStatus[] statusArray)
    {
        this.statusArray = statusArray;
    }

    public gov.lbl.srm.v22.stubs.TGetRequestFileStatus getStatusArray(int i)
    {
        return this.statusArray[i];
    }

    public void setStatusArray(int i, gov.lbl.srm.v22.stubs.TGetRequestFileStatus _value)
    {
    ...
    private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
            ArrayOfTGetRequestFileStatus.class, true);
