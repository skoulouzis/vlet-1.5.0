...
{
    private gov.lbl.srm.v22.stubs.TCopyFileRequest[] requestArray;

    public ArrayOfTCopyFileRequest()
    {
    }

    public ArrayOfTCopyFileRequest(gov.lbl.srm.v22.stubs.TCopyFileRequest[] requestArray)
    {
     ...
     * @return requestArray
     */
    public gov.lbl.srm.v22.stubs.TCopyFileRequest[] getRequestArray()
    {
        return requestArray;
    }
     ...
     * @param requestArray
     */
    public void setRequestArray(gov.lbl.srm.v22.stubs.TCopyFileRequest[] requestArray)
    {
        this.requestArray = requestArray;
    }

    public gov.lbl.srm.v22.stubs.TCopyFileRequest getRequestArray(int i)
    {
        return this.requestArray[i];
    }

    public void setRequestArray(int i, gov.lbl.srm.v22.stubs.TCopyFileRequest _value)
    {
    ...
    private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
            ArrayOfTCopyFileRequest.class, true);
