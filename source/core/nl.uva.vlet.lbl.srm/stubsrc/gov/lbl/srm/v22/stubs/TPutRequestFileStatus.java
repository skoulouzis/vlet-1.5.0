...
public class TPutRequestFileStatus implements java.io.Serializable
{
    ...
    public TPutRequestFileStatus(org.apache.axis.types.URI SURL, gov.lbl.srm.v22.stubs.TReturnStatus status,
            org.apache.axis.types.UnsignedLong fileSize, java.lang.Integer estimatedWaitTime,
            java.lang.Integer remainingPinLifetime, java.lang.Integer remainingFileLifetime,
            org.apache.axis.types.URI transferURL, gov.lbl.srm.v22.stubs.ArrayOfTExtraInfo transferProtocolInfo)
    {
        this.SURL = SURL;
        this.status = status;
    ...
    public synchronized boolean equals(java.lang.Object obj)
    {
        ...
        _equals = true
                ...
                && ((this.remainingPinLifetime == null && other.getRemainingPinLifetime() == null) || (this.remainingPinLifetime != null && this.remainingPinLifetime
                        .equals(other.getRemainingPinLifetime())))
                && ((this.remainingFileLifetime == null && other.getRemainingFileLifetime() == null) || (this.remainingFileLifetime != null && this.remainingFileLifetime
                        .equals(other.getRemainingFileLifetime())))
    ...
    private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
            TPutRequestFileStatus.class, true);
