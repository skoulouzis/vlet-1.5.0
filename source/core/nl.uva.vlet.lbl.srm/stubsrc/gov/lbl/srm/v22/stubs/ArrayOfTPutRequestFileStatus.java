...
{
    private gov.lbl.srm.v22.stubs.TPutRequestFileStatus[] statusArray;

    public ArrayOfTPutRequestFileStatus()
    {
    }

    public ArrayOfTPutRequestFileStatus(gov.lbl.srm.v22.stubs.TPutRequestFileStatus[] statusArray)
    {
     ...
     * @return statusArray
     */
    public gov.lbl.srm.v22.stubs.TPutRequestFileStatus[] getStatusArray()
    {
        return statusArray;
    }
     ...
     * @param statusArray
     */
    public void setStatusArray(gov.lbl.srm.v22.stubs.TPutRequestFileStatus[] statusArray)
    {
        this.statusArray = statusArray;
    }

    public gov.lbl.srm.v22.stubs.TPutRequestFileStatus getStatusArray(int i)
    {
        return this.statusArray[i];
    }

    public void setStatusArray(int i, gov.lbl.srm.v22.stubs.TPutRequestFileStatus _value)
    {
    ...
    private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
            ArrayOfTPutRequestFileStatus.class, true);
