...
public class SrmRmResponse implements java.io.Serializable
{
    ...
    public SrmRmResponse()
    {
    }

    public SrmRmResponse(gov.lbl.srm.v22.stubs.TReturnStatus returnStatus,
    ...
    /**
     * Gets the returnStatus value for this SrmRmResponse.
     * 
     * @return returnStatus
     */
    ...
    /**
     * Sets the returnStatus value for this SrmRmResponse.
     * 
     * @param returnStatus
     */
    ...
    /**
     * Gets the arrayOfFileStatuses value for this SrmRmResponse.
     * 
    ...
    /**
     * Sets the arrayOfFileStatuses value for this SrmRmResponse.
     * 
    ...
    {
        if (!(obj instanceof SrmRmResponse))
            return false;
        SrmRmResponse other = (SrmRmResponse) obj;
        if (obj == null)
            return false;
        if (this == obj)
            return true;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
            SrmRmResponse.class, true);

    static
    {
        typeDesc
                .setXmlType(new javax.xml.namespace.QName("http://srm.lbl.gov/StorageResourceManager", "srmRmResponse"));
