/**
 * SrmExtendFileLifeTimeResponse.java
 *
...
public class SrmExtendFileLifeTimeResponse implements java.io.Serializable
{
    ...
    public SrmExtendFileLifeTimeResponse(gov.lbl.srm.v22.stubs.TReturnStatus returnStatus,
    ...
    /**
     * Gets the returnStatus value for this SrmExtendFileLifeTimeResponse.
     * 
     * @return returnStatus
     */
    ...
    /**
     * Sets the returnStatus value for this SrmExtendFileLifeTimeResponse.
     * 
     * @param returnStatus
     */
    ...
    {
        if (!(obj instanceof SrmExtendFileLifeTimeResponse))
            return false;
        SrmExtendFileLifeTimeResponse other = (SrmExtendFileLifeTimeResponse) obj;
        if (obj == null)
            return false;
        if (this == obj)
            return true;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
            SrmExtendFileLifeTimeResponse.class, true);
