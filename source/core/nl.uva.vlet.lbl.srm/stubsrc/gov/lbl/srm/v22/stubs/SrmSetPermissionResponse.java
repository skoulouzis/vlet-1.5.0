...
public class SrmSetPermissionResponse implements java.io.Serializable
{
    ...
    public SrmSetPermissionResponse(gov.lbl.srm.v22.stubs.TReturnStatus returnStatus)
    {
        this.returnStatus = returnStatus;
    }

    /**
     * Gets the returnStatus value for this SrmSetPermissionResponse.
     * 
     * @return returnStatus
     */
    ...
    /**
     * Sets the returnStatus value for this SrmSetPermissionResponse.
     * 
     * @param returnStatus
     */
    ...
    {
        if (!(obj instanceof SrmSetPermissionResponse))
            return false;
        SrmSetPermissionResponse other = (SrmSetPermissionResponse) obj;
        if (obj == null)
            return false;
        if (this == obj)
            return true;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
            SrmSetPermissionResponse.class, true);
