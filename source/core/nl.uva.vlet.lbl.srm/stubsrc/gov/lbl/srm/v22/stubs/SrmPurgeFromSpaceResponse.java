/**
 * SrmPurgeFromSpaceResponse.java
 *
...
public class SrmPurgeFromSpaceResponse implements java.io.Serializable
{
    private gov.lbl.srm.v22.stubs.TReturnStatus returnStatus;

    private gov.lbl.srm.v22.stubs.ArrayOfTSURLReturnStatus arrayOfFileStatuses;

    public SrmPurgeFromSpaceResponse()
    {
    }

    public SrmPurgeFromSpaceResponse(gov.lbl.srm.v22.stubs.TReturnStatus returnStatus,
            gov.lbl.srm.v22.stubs.ArrayOfTSURLReturnStatus arrayOfFileStatuses)
    {
    ...
    /**
     * Gets the returnStatus value for this SrmPurgeFromSpaceResponse.
     * 
     * @return returnStatus
     */
    ...
    /**
     * Sets the returnStatus value for this SrmPurgeFromSpaceResponse.
     * 
     * @param returnStatus
     */
    ...
    /**
     * Gets the arrayOfFileStatuses value for this SrmPurgeFromSpaceResponse.
     * 
     * @return arrayOfFileStatuses
     */
    public gov.lbl.srm.v22.stubs.ArrayOfTSURLReturnStatus getArrayOfFileStatuses()
    {
        return arrayOfFileStatuses;
    }

    /**
     * Sets the arrayOfFileStatuses value for this SrmPurgeFromSpaceResponse.
     * 
     * @param arrayOfFileStatuses
     */
    public void setArrayOfFileStatuses(gov.lbl.srm.v22.stubs.ArrayOfTSURLReturnStatus arrayOfFileStatuses)
    {
        this.arrayOfFileStatuses = arrayOfFileStatuses;
    }
    ...
    {
        if (!(obj instanceof SrmPurgeFromSpaceResponse))
            return false;
        SrmPurgeFromSpaceResponse other = (SrmPurgeFromSpaceResponse) obj;
        if (obj == null)
            return false;
        if (this == obj)
            return true;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
            SrmPurgeFromSpaceResponse.class, true);
