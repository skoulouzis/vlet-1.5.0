/**
 * SrmStatusOfUpdateSpaceRequestRequest.java
 *
...
public class SrmStatusOfUpdateSpaceRequestRequest implements java.io.Serializable
{
    ...
    public SrmStatusOfUpdateSpaceRequestRequest()
    {
    }

    public SrmStatusOfUpdateSpaceRequestRequest(java.lang.String authorizationID, java.lang.String requestToken)
    {
    ...
    {
        if (!(obj instanceof SrmStatusOfUpdateSpaceRequestRequest))
            return false;
        SrmStatusOfUpdateSpaceRequestRequest other = (SrmStatusOfUpdateSpaceRequestRequest) obj;
        if (obj == null)
            return false;
        if (this == obj)
            return true;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
            SrmStatusOfUpdateSpaceRequestRequest.class, true);
