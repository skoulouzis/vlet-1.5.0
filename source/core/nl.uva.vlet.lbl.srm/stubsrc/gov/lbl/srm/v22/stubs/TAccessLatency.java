...
public class TAccessLatency implements java.io.Serializable
{
    ...
    public static TAccessLatency fromValue(java.lang.String value) throws java.lang.IllegalArgumentException
    {
        TAccessLatency enumeration = (TAccessLatency) _table_.get(value);
        if (enumeration == null)
            throw new java.lang.IllegalArgumentException();
        return enumeration;
    }

    public static TAccessLatency fromString(java.lang.String value) throws java.lang.IllegalArgumentException
    {
    ...
    private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
            TAccessLatency.class);

    static
    {
        typeDesc
                .setXmlType(new javax.xml.namespace.QName("http://srm.lbl.gov/StorageResourceManager", "TAccessLatency"));
    }
