 ...
 * ---
 * $Id: testSRMgb_se_ams_els_sara_nl.java,v 1.3 2011-06-07 15:15:26 ptdeboer Exp $  
 ...
 * @author P.T. de Boer
 */
public class testSRMgb_se_ams_els_sara_nl extends testSRM
{
    public static VRL getTestLocation()
    {
        try
        {
            return new VRL("srm://gb-se-ams.els.sara.nl:8446/dpm/els.sara.nl/home/pvier/testVFS");
        }
    ...
    public static Test suite()
    {
        ...
        return new TestSuite(testSRMgb_se_ams_els_sara_nl.class);
    }
