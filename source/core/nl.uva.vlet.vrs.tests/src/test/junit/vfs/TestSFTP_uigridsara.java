 ...
 * @author P.T. de Boer
 */
public class TestSFTP_uigridsara extends testVFS
{
    static private ServerInfo info;

    public TestSFTP_uigridsara()
    {
        // this.doRename=false;
        // this.doWrites=false;
    }
    ...
    {
        return new VRL("sftp","ptdeboer","ui.grid.sara.nl",22,"/tmp/testSftpVlet1"); 
        //TestSettings.getTestLocation(TestSettings.VFS_SFTP_LOCALHOST); 
    }
    ...
    public static Test suite()
    {
        ...
        return new TestSuite(TestSFTP_uigridsara.class);
    }
