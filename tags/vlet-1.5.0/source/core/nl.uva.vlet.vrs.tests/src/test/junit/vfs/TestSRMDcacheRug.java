 ...
 * ---
 * $Id: TestSRMDcacheRug.java,v 1.4 2011-05-10 15:05:25 ptdeboer Exp $  
 ...
 * @author P.T. de Boer
 */
public class TestSRMDcacheRug extends testSRM
{
    public static VRL getTestLocation()
    {
        return TestSettings.getTestLocation(TestSettings.VFS_SRM_DCACHE_RUG_LOCATION);
    }
    ...
    public static Test suite()
    {
        ...
        return new TestSuite(TestSRMDcacheRug.class);
    }
