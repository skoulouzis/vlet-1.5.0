 ...
 * ---
 * $Id: testSRMTSara.java,v 1.1 2011-10-03 14:36:12 ptdeboer Exp $  
 * $Date: 2011-10-03 14:36:12 $
 */ 
// source: 
 ...
 * @author P.T. de Boer
 */
public class testSRMTSara extends testSRM
{
    public static VRL getTestLocation()
    {
        return TestSettings.getTestLocation(TestSettings.VFS_SRM_T_DCACHE_SARA_LOCATION);
    }
    ...
    public static Test suite()
    {
        ...
        return new TestSuite(testSRMTSara.class);
    }
