 ...
 * ---
 * $Id: testGFTP_V1_0_active.java,v 1.6 2011-05-02 13:28:47 ptdeboer Exp $  
...
public class testGFTP_V1_0_active
{
    ...
    public static Test suite()
    {
        ...
        try
        {
            ServerInfo info = VRSContext.getDefault().getServerInfoFor(TestSettings.getTestLocation(TestSettings.VFS_GFTP_V1_LOCATION), true);
