 ...
 * ---
 * $Id: testSRMCastorUK.java,v 1.5 2011-05-10 15:05:25 ptdeboer Exp $  
 ...
 * @author P.T. de Boer
 */
public class testSRMCastorUK extends testSRM
{
    public static VRL getTestLocation()
    {
        return TestSettings.getTestLocation(TestSettings.VFS_SRM_CASTORUK_LOCATION);
    }
    ...
    public static Test suite()
    {
        ...
        return new TestSuite(testSRMCastorUK.class);
    }
