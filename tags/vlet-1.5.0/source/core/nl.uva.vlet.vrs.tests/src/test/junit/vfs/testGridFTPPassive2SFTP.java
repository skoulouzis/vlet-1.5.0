 ...
 * ---
 * $Id: testGridFTPPassive2SFTP.java,v 1.4 2011-09-23 13:38:06 ptdeboer Exp $  
 ...
 * 
 * TestSuite uses testVFS class to stream copyin between GFTP as remote 
 * an SFTP as "local"
 * 
 * @author P.T. de Boer
 */
public class testGridFTPPassive2SFTP extends testVFS
{
    @Override
    ...
    public static Test suite()
    {
        ...
        return new TestSuite(testGridFTPPassive2SFTP.class);
    }
