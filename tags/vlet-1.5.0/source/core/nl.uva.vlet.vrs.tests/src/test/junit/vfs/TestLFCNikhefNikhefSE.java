 ...
 * ---
 * $Id: TestLFCNikhefNikhefSE.java,v 1.6 2011-05-02 13:28:47 ptdeboer Exp $  
 ...
 * @author P.T. de Boer
 */
public class TestLFCNikhefNikhefSE extends testVFS
{
    @Override
    public VRL getRemoteLocation()
    {
        return TestSettings.testLFCJNikhefLocation;
    }
    ...
    public static Test suite()
    {
        ...
        ServerInfo info = ServerInfo.createFor(context, TestSettings.testLFCJNikhefLocation);
        info.setAttribute(LFCFSConfig.ATTR_PREFERREDSSES, "tbn18.nikhef.nl");
        ...
        return new TestSuite(TestLFCNikhefNikhefSE.class);
    }
