 ...
 * ---
 * $Id: testSRMNikhefTBN01.java,v 1.4 2011-05-02 13:28:46 ptdeboer Exp $  
 ...
 * @author P.T. de Boer
 */
public class testSRMNikhefTBN01 extends testSRMSara
{
    public static VRL getTestLocation()
    {
        ...
        return new VRL("srm","tbn01.nikhef.nl",8446,"/dpm/nikhef.nl/home/pvier/"+user+"/testSRM_DPM_NIKHEF");
    }
    ...
    public static Test suite()
    {
        ...
        return new TestSuite(testSRMNikhefTBN01.class);
    }
