 ...
 * ---
 * $Id: testSRMSToRMIt.java,v 1.3 2011-05-10 15:05:25 ptdeboer Exp $  
 ...
 * @author P.T. de Boer
 */
public class testSRMSToRMIt extends testSRM
{
    public static VRL getTestLocation()
    {
        return TestSettings.getTestLocation(TestSettings.VFS_SRM_STORMIT_LOCATION);        
    }
    ...
    public static Test suite()
    {
        ...
        return new TestSuite(testSRMSToRMIt.class);
    }
