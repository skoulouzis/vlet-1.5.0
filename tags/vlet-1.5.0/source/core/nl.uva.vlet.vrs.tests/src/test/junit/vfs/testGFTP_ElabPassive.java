 ...
 * ---
 * $Id: testGFTP_ElabPassive.java,v 1.1 2011-09-30 13:44:55 ptdeboer Exp $  
...
public class testGFTP_ElabPassive extends testVFS
{
    @Override
    public VRL getRemoteLocation()
    {
        return TestSettings.getTestLocation(TestSettings.VFS_GFTP_ELAB_LOCATION);
    }
    ...
    public static Test suite()
    {
        ...
        return new TestSuite(testGFTP_ElabPassive.class);
    }
