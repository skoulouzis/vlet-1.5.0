 ...
 * ---
 * $Id: TestLFCSaraRandomSE.java,v 1.6 2011-05-02 13:28:47 ptdeboer Exp $  
 ...
 * @author P.T. de Boer
 */
public class TestLFCSaraRandomSE extends testVFS
{
    @Override
    ...
    public static Test suite()
    {
        ...
        // ========
        // CLEAR preferred to use Random Storage Elements !
        info.setAttribute(LFCFSConfig.ATTR_PREFERREDSSES, "");
        info.setAttribute(LFCFSConfig.ATTR_REPLICA_CREATION_MODE, ReplicaCreationMode.VORANDOM.getValue());
        // ========
        //
        ...
        return new TestSuite(TestLFCSaraRandomSE.class);
    }
