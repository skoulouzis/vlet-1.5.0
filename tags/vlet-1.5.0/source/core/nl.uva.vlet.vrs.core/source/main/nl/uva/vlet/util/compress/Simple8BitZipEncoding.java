 ...
 * ---
 * $Id: Simple8BitZipEncoding.java,v 1.2 2011-04-18 12:00:28 ptdeboer Exp $  
...
class Simple8BitZipEncoding implements ZipEncoding
{
     ...
     * encoding.
     */
    private static final class Simple8BitChar implements Comparable<Object>
    {
    ...
    public Simple8BitZipEncoding(char[] highChars)
    {
        ...
        this.reverseMapping = new ArrayList<Simple8BitChar>(this.highChars.length);
     ...
     *            The character to encode.
     * @return Whether the given unicode character is covered by this encoding.
     *         If <code>false</code> is returned, nothing is pushed to the byte
     *         buffer.
     */
