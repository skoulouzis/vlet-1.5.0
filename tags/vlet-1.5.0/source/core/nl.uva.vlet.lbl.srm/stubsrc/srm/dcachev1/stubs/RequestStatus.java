...
public class RequestStatus implements java.io.Serializable
{
    ...
    private srm.dcachev1.stubs.RequestFileStatus[] fileStatuses;
    ...
    public RequestStatus(int requestId, java.lang.String type, java.lang.String state, java.util.Calendar submitTime,
            java.util.Calendar startTime, java.util.Calendar finishTime, int estTimeToStart,
            srm.dcachev1.stubs.RequestFileStatus[] fileStatuses, java.lang.String errorMessage, int retryDeltaTime)
    {
     ...
     * @return fileStatuses
     */
    public srm.dcachev1.stubs.RequestFileStatus[] getFileStatuses()
    {
        return fileStatuses;
    }
     ...
     * @param fileStatuses
     */
    public void setFileStatuses(srm.dcachev1.stubs.RequestFileStatus[] fileStatuses)
    {
        this.fileStatuses = fileStatuses;
    }
    ...
    public synchronized boolean equals(java.lang.Object obj)
    {
        ...
        _equals = true
                ...
                && ((this.type == null && other.getType() == null) || (this.type != null && this.type.equals(other
                        .getType())))
                && ((this.state == null && other.getState() == null) || (this.state != null && this.state.equals(other
                        .getState())))
                && ((this.submitTime == null && other.getSubmitTime() == null) || (this.submitTime != null && this.submitTime
                ...
                && ((this.fileStatuses == null && other.getFileStatuses() == null) || (this.fileStatuses != null && java.util.Arrays
                        .equals(this.fileStatuses, other.getFileStatuses())))
                && ((this.errorMessage == null && other.getErrorMessage() == null) || (this.errorMessage != null && this.errorMessage
                        .equals(other.getErrorMessage()))) && this.retryDeltaTime == other.getRetryDeltaTime();
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode()
    {
        ...
        {
            for (int i = 0; i < java.lang.reflect.Array.getLength(getFileStatuses()); i++)
            {
    ...
    private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
            RequestStatus.class, true);

    static
    {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.themindelectric.com/package/diskCacheV111.srm/",
                "RequestStatus"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.themindelectric.com/package/diskCacheV111.srm/",
                "RequestFileStatus"));
        elemField.setNillable(true);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
