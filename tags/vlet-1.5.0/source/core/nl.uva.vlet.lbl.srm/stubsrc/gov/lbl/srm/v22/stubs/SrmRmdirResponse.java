...
public class SrmRmdirResponse implements java.io.Serializable
{
    private gov.lbl.srm.v22.stubs.TReturnStatus returnStatus;

    public SrmRmdirResponse()
    {
    }

    public SrmRmdirResponse(gov.lbl.srm.v22.stubs.TReturnStatus returnStatus)
    {
        this.returnStatus = returnStatus;
    }

    /**
     * Gets the returnStatus value for this SrmRmdirResponse.
     * 
     * @return returnStatus
     */
    ...
    /**
     * Sets the returnStatus value for this SrmRmdirResponse.
     * 
     * @param returnStatus
     */
    ...
    {
        if (!(obj instanceof SrmRmdirResponse))
            return false;
        SrmRmdirResponse other = (SrmRmdirResponse) obj;
        if (obj == null)
            return false;
        if (this == obj)
            return true;
