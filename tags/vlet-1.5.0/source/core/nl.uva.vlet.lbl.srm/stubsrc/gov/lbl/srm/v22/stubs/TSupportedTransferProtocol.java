...
public class TSupportedTransferProtocol implements java.io.Serializable
{
    ...
    private gov.lbl.srm.v22.stubs.ArrayOfTExtraInfo attributes;

    public TSupportedTransferProtocol()
    {
    }

    public TSupportedTransferProtocol(java.lang.String transferProtocol,
            gov.lbl.srm.v22.stubs.ArrayOfTExtraInfo attributes)
    {
     ...
     * @return attributes
     */
    public gov.lbl.srm.v22.stubs.ArrayOfTExtraInfo getAttributes()
    {
        return attributes;
    }
     ...
     * @param attributes
     */
    public void setAttributes(gov.lbl.srm.v22.stubs.ArrayOfTExtraInfo attributes)
    {
        this.attributes = attributes;
    }
    ...
    public synchronized boolean equals(java.lang.Object obj)
    {
        ...
        boolean _equals;
        _equals = true
                && ((this.transferProtocol == null && other.getTransferProtocol() == null) || (this.transferProtocol != null && this.transferProtocol
                        .equals(other.getTransferProtocol())))
    ...
    private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
            TSupportedTransferProtocol.class, true);
