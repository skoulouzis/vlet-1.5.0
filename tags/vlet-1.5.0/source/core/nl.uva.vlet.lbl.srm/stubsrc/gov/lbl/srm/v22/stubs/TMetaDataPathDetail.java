...
public class TMetaDataPathDetail implements java.io.Serializable
{
    ...
    private gov.lbl.srm.v22.stubs.TFileStorageType fileStorageType;

    private gov.lbl.srm.v22.stubs.TRetentionPolicyInfo retentionPolicyInfo;

    private gov.lbl.srm.v22.stubs.TFileLocality fileLocality;

    private gov.lbl.srm.v22.stubs.ArrayOfString arrayOfSpaceTokens;

    private gov.lbl.srm.v22.stubs.TFileType type;

    private java.lang.Integer lifetimeAssigned;

    private java.lang.Integer lifetimeLeft;

    private gov.lbl.srm.v22.stubs.TUserPermission ownerPermission;

    private gov.lbl.srm.v22.stubs.TGroupPermission groupPermission;
    ...
    private gov.lbl.srm.v22.stubs.ArrayOfTMetaDataPathDetail arrayOfSubPaths;

    public TMetaDataPathDetail()
    {
    }

    public TMetaDataPathDetail(java.lang.String path, gov.lbl.srm.v22.stubs.TReturnStatus status,
            org.apache.axis.types.UnsignedLong size, java.util.Calendar createdAtTime,
            java.util.Calendar lastModificationTime, gov.lbl.srm.v22.stubs.TFileStorageType fileStorageType,
            gov.lbl.srm.v22.stubs.TRetentionPolicyInfo retentionPolicyInfo,
            gov.lbl.srm.v22.stubs.TFileLocality fileLocality, gov.lbl.srm.v22.stubs.ArrayOfString arrayOfSpaceTokens,
            gov.lbl.srm.v22.stubs.TFileType type, java.lang.Integer lifetimeAssigned, java.lang.Integer lifetimeLeft,
            gov.lbl.srm.v22.stubs.TUserPermission ownerPermission,
            gov.lbl.srm.v22.stubs.TGroupPermission groupPermission,
            gov.lbl.srm.v22.stubs.TPermissionMode otherPermission, java.lang.String checkSumType,
            java.lang.String checkSumValue, gov.lbl.srm.v22.stubs.ArrayOfTMetaDataPathDetail arrayOfSubPaths)
    {
        this.path = path;
        this.status = status;
        this.size = size;
     ...
     */
    public gov.lbl.srm.v22.stubs.TFileStorageType getFileStorageType()
    {
        return fileStorageType;
    }
     ...
     */
    public void setFileStorageType(gov.lbl.srm.v22.stubs.TFileStorageType fileStorageType)
    {
        this.fileStorageType = fileStorageType;
    }
     ...
     */
    public gov.lbl.srm.v22.stubs.TRetentionPolicyInfo getRetentionPolicyInfo()
    {
        return retentionPolicyInfo;
    }
     ...
     */
    public void setRetentionPolicyInfo(gov.lbl.srm.v22.stubs.TRetentionPolicyInfo retentionPolicyInfo)
    {
        this.retentionPolicyInfo = retentionPolicyInfo;
    }
     ...
     * @return fileLocality
     */
    public gov.lbl.srm.v22.stubs.TFileLocality getFileLocality()
    {
        return fileLocality;
    }
     ...
     * @param fileLocality
     */
    public void setFileLocality(gov.lbl.srm.v22.stubs.TFileLocality fileLocality)
    {
        this.fileLocality = fileLocality;
    }
     ...
     * @return type
     */
    public gov.lbl.srm.v22.stubs.TFileType getType()
    {
        return type;
    }
     ...
     * @param type
     */
    public void setType(gov.lbl.srm.v22.stubs.TFileType type)
    {
        this.type = type;
    }
     ...
     */
    public gov.lbl.srm.v22.stubs.TUserPermission getOwnerPermission()
    {
        return ownerPermission;
    }
     ...
     */
    public void setOwnerPermission(gov.lbl.srm.v22.stubs.TUserPermission ownerPermission)
    {
        this.ownerPermission = ownerPermission;
    }
     ...
     */
    public gov.lbl.srm.v22.stubs.TGroupPermission getGroupPermission()
    {
        return groupPermission;
    }
     ...
     */
    public void setGroupPermission(gov.lbl.srm.v22.stubs.TGroupPermission groupPermission)
    {
        this.groupPermission = groupPermission;
    }
     ...
     */
    public gov.lbl.srm.v22.stubs.ArrayOfTMetaDataPathDetail getArrayOfSubPaths()
    {
        return arrayOfSubPaths;
    }
     ...
     */
    public void setArrayOfSubPaths(gov.lbl.srm.v22.stubs.ArrayOfTMetaDataPathDetail arrayOfSubPaths)
    {
        this.arrayOfSubPaths = arrayOfSubPaths;
    }
    ...
    public synchronized boolean equals(java.lang.Object obj)
    {
        ...
        boolean _equals;
        _equals = true
                && ((this.path == null && other.getPath() == null) || (this.path != null && this.path.equals(other
                        .getPath())))
                && ((this.status == null && other.getStatus() == null) || (this.status != null && this.status
                        .equals(other.getStatus())))
                && ((this.size == null && other.getSize() == null) || (this.size != null && this.size.equals(other
                        .getSize())))
                && ((this.createdAtTime == null && other.getCreatedAtTime() == null) || (this.createdAtTime != null && this.createdAtTime
                        .equals(other.getCreatedAtTime())))
                && ((this.lastModificationTime == null && other.getLastModificationTime() == null) || (this.lastModificationTime != null && this.lastModificationTime
                        .equals(other.getLastModificationTime())))
                && ((this.fileStorageType == null && other.getFileStorageType() == null) || (this.fileStorageType != null && this.fileStorageType
                        .equals(other.getFileStorageType())))
                && ((this.retentionPolicyInfo == null && other.getRetentionPolicyInfo() == null) || (this.retentionPolicyInfo != null && this.retentionPolicyInfo
                        .equals(other.getRetentionPolicyInfo())))
                && ((this.fileLocality == null && other.getFileLocality() == null) || (this.fileLocality != null && this.fileLocality
                        .equals(other.getFileLocality())))
                ...
                && ((this.type == null && other.getType() == null) || (this.type != null && this.type.equals(other
                        .getType())))
                && ((this.lifetimeAssigned == null && other.getLifetimeAssigned() == null) || (this.lifetimeAssigned != null && this.lifetimeAssigned
                        .equals(other.getLifetimeAssigned())))
                && ((this.lifetimeLeft == null && other.getLifetimeLeft() == null) || (this.lifetimeLeft != null && this.lifetimeLeft
                        .equals(other.getLifetimeLeft())))
                ...
                && ((this.groupPermission == null && other.getGroupPermission() == null) || (this.groupPermission != null && this.groupPermission
                        .equals(other.getGroupPermission())))
                ...
                && ((this.checkSumType == null && other.getCheckSumType() == null) || (this.checkSumType != null && this.checkSumType
                        .equals(other.getCheckSumType())))
                ...
                && ((this.arrayOfSubPaths == null && other.getArrayOfSubPaths() == null) || (this.arrayOfSubPaths != null && this.arrayOfSubPaths
                        .equals(other.getArrayOfSubPaths())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
            TMetaDataPathDetail.class, true);
    ...
    static
    {
        ...
        elemField
                .setXmlType(new javax.xml.namespace.QName("http://srm.lbl.gov/StorageResourceManager", "TFileLocality"));
        elemField.setMinOccurs(0);
        elemField.setNillable(true);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
