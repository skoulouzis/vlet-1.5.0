...
public class SrmCopyRequest implements java.io.Serializable
{
    ...
    private gov.lbl.srm.v22.stubs.ArrayOfTCopyFileRequest arrayOfFileRequests;
    ...
    private gov.lbl.srm.v22.stubs.TFileStorageType targetFileStorageType;
    ...
    private gov.lbl.srm.v22.stubs.ArrayOfTExtraInfo sourceStorageSystemInfo;

    private gov.lbl.srm.v22.stubs.ArrayOfTExtraInfo targetStorageSystemInfo;

    public SrmCopyRequest()
    {
    }

    public SrmCopyRequest(java.lang.String authorizationID,
            gov.lbl.srm.v22.stubs.ArrayOfTCopyFileRequest arrayOfFileRequests, java.lang.String userRequestDescription,
            gov.lbl.srm.v22.stubs.TOverwriteMode overwriteOption, java.lang.Integer desiredTotalRequestTime,
            java.lang.Integer desiredTargetSURLLifeTime, gov.lbl.srm.v22.stubs.TFileStorageType targetFileStorageType,
            java.lang.String targetSpaceToken,
            gov.lbl.srm.v22.stubs.TRetentionPolicyInfo targetFileRetentionPolicyInfo,
            gov.lbl.srm.v22.stubs.ArrayOfTExtraInfo sourceStorageSystemInfo,
            gov.lbl.srm.v22.stubs.ArrayOfTExtraInfo targetStorageSystemInfo)
    {
     ...
     */
    public gov.lbl.srm.v22.stubs.ArrayOfTCopyFileRequest getArrayOfFileRequests()
    {
        return arrayOfFileRequests;
    }
     ...
     */
    public void setArrayOfFileRequests(gov.lbl.srm.v22.stubs.ArrayOfTCopyFileRequest arrayOfFileRequests)
    {
        this.arrayOfFileRequests = arrayOfFileRequests;
    }
     ...
     */
    public gov.lbl.srm.v22.stubs.TFileStorageType getTargetFileStorageType()
    {
        return targetFileStorageType;
    }
     ...
     */
    public void setTargetFileStorageType(gov.lbl.srm.v22.stubs.TFileStorageType targetFileStorageType)
    {
        this.targetFileStorageType = targetFileStorageType;
    }
     ...
     */
    public gov.lbl.srm.v22.stubs.ArrayOfTExtraInfo getSourceStorageSystemInfo()
    {
        return sourceStorageSystemInfo;
    }
     ...
     */
    public void setSourceStorageSystemInfo(gov.lbl.srm.v22.stubs.ArrayOfTExtraInfo sourceStorageSystemInfo)
    {
        this.sourceStorageSystemInfo = sourceStorageSystemInfo;
    }
     ...
     */
    public gov.lbl.srm.v22.stubs.ArrayOfTExtraInfo getTargetStorageSystemInfo()
    {
        return targetStorageSystemInfo;
    }
     ...
     */
    public void setTargetStorageSystemInfo(gov.lbl.srm.v22.stubs.ArrayOfTExtraInfo targetStorageSystemInfo)
    {
        this.targetStorageSystemInfo = targetStorageSystemInfo;
    }
    ...
    public synchronized boolean equals(java.lang.Object obj)
    {
        ...
        _equals = true
                ...
                && ((this.desiredTargetSURLLifeTime == null && other.getDesiredTargetSURLLifeTime() == null) || (this.desiredTargetSURLLifeTime != null && this.desiredTargetSURLLifeTime
                        .equals(other.getDesiredTargetSURLLifeTime())))
                && ((this.targetFileStorageType == null && other.getTargetFileStorageType() == null) || (this.targetFileStorageType != null && this.targetFileStorageType
                        .equals(other.getTargetFileStorageType())))
                ...
                && ((this.sourceStorageSystemInfo == null && other.getSourceStorageSystemInfo() == null) || (this.sourceStorageSystemInfo != null && this.sourceStorageSystemInfo
                        .equals(other.getSourceStorageSystemInfo())))
                && ((this.targetStorageSystemInfo == null && other.getTargetStorageSystemInfo() == null) || (this.targetStorageSystemInfo != null && this.targetStorageSystemInfo
                        .equals(other.getTargetStorageSystemInfo())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
            SrmCopyRequest.class, true);

    static
    {
        typeDesc
                .setXmlType(new javax.xml.namespace.QName("http://srm.lbl.gov/StorageResourceManager", "srmCopyRequest"));
