/**
 * SrmSuspendRequestResponse.java
 *
...
public class SrmSuspendRequestResponse implements java.io.Serializable
{
    private gov.lbl.srm.v22.stubs.TReturnStatus returnStatus;

    public SrmSuspendRequestResponse()
    {
    }

    public SrmSuspendRequestResponse(gov.lbl.srm.v22.stubs.TReturnStatus returnStatus)
    {
        this.returnStatus = returnStatus;
    }

    /**
     * Gets the returnStatus value for this SrmSuspendRequestResponse.
     * 
     * @return returnStatus
     */
    ...
    /**
     * Sets the returnStatus value for this SrmSuspendRequestResponse.
     * 
     * @param returnStatus
     */
    ...
    {
        if (!(obj instanceof SrmSuspendRequestResponse))
            return false;
        SrmSuspendRequestResponse other = (SrmSuspendRequestResponse) obj;
        if (obj == null)
            return false;
        if (this == obj)
            return true;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
            SrmSuspendRequestResponse.class, true);
