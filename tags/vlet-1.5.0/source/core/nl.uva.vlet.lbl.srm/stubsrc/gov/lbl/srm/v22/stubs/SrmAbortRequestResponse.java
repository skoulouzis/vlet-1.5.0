...
public class SrmAbortRequestResponse implements java.io.Serializable
{
    ...
    public SrmAbortRequestResponse(gov.lbl.srm.v22.stubs.TReturnStatus returnStatus)
    {
        this.returnStatus = returnStatus;
    }

    /**
     * Gets the returnStatus value for this SrmAbortRequestResponse.
     * 
     * @return returnStatus
     */
    ...
    /**
     * Sets the returnStatus value for this SrmAbortRequestResponse.
     * 
     * @param returnStatus
     */
    ...
    {
        if (!(obj instanceof SrmAbortRequestResponse))
            return false;
        SrmAbortRequestResponse other = (SrmAbortRequestResponse) obj;
        if (obj == null)
            return false;
        if (this == obj)
            return true;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(
            SrmAbortRequestResponse.class, true);
